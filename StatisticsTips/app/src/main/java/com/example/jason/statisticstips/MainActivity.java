...
//            }
    ...
    //switchToNextPage
    public void configureToTipsButton(){
        //set on button listener
        Button toTipsButton = findViewById(R.id.toTips);
        toTipsButton.setOnClickListener(new View.OnClickListener(){
            @Override
